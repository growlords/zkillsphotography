...
export const Preloader: React.FC<PreloaderProps> = ({ onComplete }) => {
  ...
  return (
    <div
      className={`fixed inset-0 z-[10000] bg-dark-950 flex flex-col items-center justify-center transition-opacity duration-700 ease-in-out ${
    ...
    >
      <div className="text-center px-6 max-w-xl">
        ...
        <div className="w-48 sm:w-64 h-[2px] bg-dark-800 mx-auto overflow-hidden relative mb-4">
          <div
